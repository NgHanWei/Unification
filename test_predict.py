...
for i_fold in range(0,num_folds):
    ...
    model_save_path = '/home/hanwei/Unification/models/model_weights_' + str(i_fold) + '.pth'
    ...
    _ = clf.fit(dataset, y=None, epochs=0)

    print(X_test[1].shape)
    clf_pred2 = clf.predict_proba(X_test[[1]])
    print(np.argmax(clf_pred2))
